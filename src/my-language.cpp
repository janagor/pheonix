...
(with .l extention)")("parser,p",
                      "create a file with result of syntax analysis \
(with .p extention)")("semantic,s",
                      "create a file with result of semantic analysis \
(with .s extention)")(
...
(with .ir extention)");
    ...
    hidden.add_options()("input-file", po::value<string>(&file_name));
