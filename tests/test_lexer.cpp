...
const map<const string, const Token> SPECIAL_CHARS_AND_KEYWORDS{
    {"=", Token(TokenType::ASSIGN)},      {"!", Token(TokenType::BANG)},
    {"+", Token(TokenType::PLUS)},        {"-", Token(TokenType::MINUS)},
    {"*", Token(TokenType::STAR)},        {"%", Token(TokenType::PERCENT)},
    {"#", Token(TokenType::HASH)},        {"|", Token(TokenType::PIPE)},
    {"$", Token(TokenType::DOLAR)},       {";", Token(TokenType::SEMICOLON)},
    {",", Token(TokenType::COMMA)},       {"(", Token(TokenType::LPARENT)},
    {")", Token(TokenType::RPARENT)},     {"{", Token(TokenType::LBRACE)},
    {"}", Token(TokenType::RBRACE)},      {"[", Token(TokenType::LBRACKET)},
    {"]", Token(TokenType::RBRACKET)},    {"==", Token(TokenType::EQUALS)},
    {"&&", Token(TokenType::AND)},        {"||", Token(TokenType::OR)},
    {"<=", Token(TokenType::LEQ)},        {">=", Token(TokenType::GEQ)},
    {"<-", Token(TokenType::LARROW)},     {"fn", Token(TokenType::FN)},
    {"let", Token(TokenType::LET)},       {"mut", Token(TokenType::MUT)},
    {"return", Token(TokenType::RETURN)}, {"if", Token(TokenType::IF)},
    {"else", Token(TokenType::ELSE)},     {"while", Token(TokenType::WHILE)},
    {"int", Token(TokenType::INT)},       {"str", Token(TokenType::STR)},
    {"flt", Token(TokenType::FLT)},       {"bol", Token(TokenType::BOL)},
