...
const map<const string, const Token> SPECIAL_CHARS_AND_KEYWORDS{
    ...
    {"#", Token(HASH)},     {"$", Token(DOLAR)},       {";", Token(SEMICOLON)},
    {",", Token(COMMA)},    {"(", Token(LPARENT)},     {")", Token(RPARENT)},
    {"{", Token(LBRACE)},   {"}", Token(RBRACE)},      {"[", Token(LBRACKET)},
    {"]", Token(RBRACKET)}, {"==", Token(EQUALS)},     {"&&", Token(AND)},
    {"||", Token(OR)},      {"<=", Token(LEQ)},        {">=", Token(GEQ)},
    {"<-", Token(LARROW)},  {"fn", Token(FN)},         {"let", Token(LET)},
    {"mut", Token(MUT)},    {"return", Token(RETURN)}, {"if", Token(IF)},
    {"else", Token(ELSE)},  {"while", Token(WHILE)},   {"int", Token(INT)},
    {"str", Token(STR)},    {"flt", Token(FLT)},       {"bol", Token(BOL)},
...
const map<const string, const string> INTEGERS_ERRORS{
    ...
    {to_string(2 * static_cast<long>(numeric_limits<int>::max())),
     "Integer literal out of range."},
    {to_string(21321) + "a", "Undefined value."},
};
